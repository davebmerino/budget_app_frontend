      ...
      <div className="min-h-screen bg-vault-bg text-vault-text flex flex-col justify-between items-center px-4 py-8 antialiased selection:bg-emerald-primary selection:text-black">
        ...
        <div className="w-full max-w-[430px] flex flex-col items-center my-auto">
          ...
          <p className="text-vault-subtext text-sm text-center max-w-xs mb-8">
            Sign in to access your financial vaults and allocated intelligence.
          </p>
          ...
          <div className="w-full bg-vault-card border border-vault-border rounded-2xl p-6 shadow-vault-card">
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <a
                        href="#forgot"
                        className="text-xs text-emerald-accent hover:underline font-mono"
                      >
                        Forgot Password?
                      </a>
                    </div>
              ...
              {/* Trust Terminal & Face ID */}
              <div className="flex items-center justify-between pt-1">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="trustTerminal"
                    className="border-vault-border data-[state=checked]:bg-emerald-primary data-[state=checked]:text-black data-[state=checked]:border-emerald-primary rounded"
                  />
                  <FieldLabel
                    htmlFor="trustTerminal"
                    className="text-xs text-vault-subtext cursor-pointer"
                  >
                    Trust this terminal
                  </FieldLabel>
                </div>
